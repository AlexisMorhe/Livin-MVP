  ...
  return (
    <div className='bg-yellow-300 text-dark w-full px-40 relative h-[50vh] flex justify-between text-dark'>
      ...
      <div className='flex flex-col h-full z-10 w-3/5 pl-20 justify-between py-10 relative'>
        <div>
          <h3 className='font-domaine-medium text-lg xl:text-[3.25rem]'>Consigue tu preaprobación</h3>
        ...
        <div className='w-full flex justify-end mt-20 '>
          <Link href='/registro'><a
            className='py-3 px-9 w-1/3 pr-20 text-center bg-dark text-white font-chillax font-medium rounded-md hover:bg-yellow-300 transition-all'>Proceso
