  ...
  return (
    <div className='bg-gray-50 w-full sm:w-1/2 xl:w-11/12 px-0 sm:px-12 relative h-full sm:h-[63vh] text-dark flex flex-col sm:flex-row'>
      ...
      <div className='flex flex-col h-full z-10 w-full sm:w-2/5 pt-4 sm:pt-0 pl-0 sm:pl-20 justify-start sm:justify-center relative'>
        <h1 className='font-domaine-bold tracking-wide text-4xl sm:text-5xl 2xl:text-[3.75rem] my-4 leading-tight pl-4 sm:pl-0 w-full'>Consigue la casa de tus sueños sin enganche.</h1>
        <p className='font-rebond w-full my-5 text-lg 2xl:text-2xl px-4 sm:px-0'>Encuentra la casa de tus sueños, mudate ahora y rentala. Parte de renta se irá directo al enganche. Nuestro programa está diseñado para que puedas conseguir tu hipoteca en 3 años.</p>
        <div className='flex w-full justify-center sm:w-1/2 xl:w-full'>
